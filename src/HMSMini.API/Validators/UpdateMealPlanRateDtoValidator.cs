...
/// <summary>
/// Validator for UpdateMealPlanRateDto
/// </summary>
public class UpdateMealPlanRateDtoValidator : AbstractValidator<UpdateMealPlanRateDto>
{
    public UpdateMealPlanRateDtoValidator()
    {
