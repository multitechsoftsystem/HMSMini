...
/// <summary>
/// Validator for CreateCompanyTariffDto
/// </summary>
public class CreateCompanyTariffDtoValidator : AbstractValidator<CreateCompanyTariffDto>
{
    public CreateCompanyTariffDtoValidator()
    {
